...
func (bcs *BlockchainServer) GetChain(w http.ResponseWriter, req *http.Request) {
	...
	default:
		log.Printf("ERROR: Invalid HTTP Method GetChain %v", req.Method)
	}
}
...
func (bcs *BlockchainServer) Transactions(w http.ResponseWriter, req *http.Request) {
	...
	default:
		log.Printf("ERROR: Invalid HTTP Method blockchain_server transactions %v", req.Method)
		w.WriteHeader(http.StatusBadRequest)
	}
}
...
func (bcs *BlockchainServer) Mine(w http.ResponseWriter, req *http.Request) {
	...
	case http.MethodGet:
		...
		io.WriteString(w, string(m))
	default:
		log.Printf("ERROR: Invalid HTTP Method Mine %v", req.Method)
		w.WriteHeader(http.StatusBadRequest)
	}
}
...
func (bcs *BlockchainServer) Amount(w http.ResponseWriter, req *http.Request) {
	...
	default:
		log.Printf("ERROR: Invalid HTTP Method Amount %v", req.Method)
		w.WriteHeader(http.StatusBadRequest)
	}
}
...
func (bcs *BlockchainServer) Consensus(w http.ResponseWriter, req *http.Request) {
	...
	default:
		log.Printf("ERROR: Invalid HTTP Method Consensus %v", req.Method)
		w.WriteHeader(http.StatusBadRequest)
	}
}
